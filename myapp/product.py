...
from flask import Flask,Blueprint, render_template, redirect, url_for, flash, request, send_from_directory, current_app
...
@product.route('/samuel/<surname>')
def samuel(surname):

    return f'hello {surname}'